...
export function AdminIconDashboard({ className = "h-4 w-4" }: IconProps) {
  return (
...
export function AdminIconPlans({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function AdminIconCustomers({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function AdminIconContent({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function AdminIconSettings({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function AdminIconMenu({ className = "h-5 w-5" }: IconProps) {
  return (
...
const iconMap = {
  dashboard: AdminIconDashboard,
  plans: AdminIconPlans,
  customers: AdminIconCustomers,
  content: AdminIconContent,
  settings: AdminIconSettings,
} as const;
